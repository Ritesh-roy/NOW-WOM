...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — HLC Technologies" },
      { name: "description", content: "Terms governing the use of HLC Technologies website and logistics services." },
    ],
  }),
  component: TermsPage,
});
    ...
    <>
      ...
      <Section className="!py-16">
        <div className="mx-auto max-w-3xl space-y-8 text-muted-foreground">
          {[
            { h: "1. Acceptance", p: "By accessing or using the HLC Technologies website or services, you agree to be bound by these Terms of Service and all applicable laws and regulations." },
            ...
            { h: "3. Quotes & Bookings", p: "Quotes are valid for the period stated and are subject to change based on fuel surcharges, regulatory updates, and capacity. Bookings are confirmed only upon written acceptance by HLC Technologies." },
            ...
            { h: "6. Intellectual property", p: "All content, trademarks, and materials on this website are the property of HLC Technologies and may not be reproduced without permission." },
            ...
            { h: "8. Contact", p: "Questions about these terms? Reach us at sales@hlctechnologies.in or +91 98912 10081." },
          ].map((s) => (
            <div key={s.h}>
